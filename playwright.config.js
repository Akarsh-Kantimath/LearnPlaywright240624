...
const config = {
  ...
  timeout : 30 * 1000,  //30 sec added as a timeout - maximum time one test can run for, for any reason if the test fail to execute - it will report as a failure post 30 sec
